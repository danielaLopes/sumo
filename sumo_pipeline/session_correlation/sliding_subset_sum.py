...
class PreProcessedFullPipelineState(State):
    ...
    def plot(self) -> None:
        ...
        results_plot_maker.precision_recall_curve_with_threshold_single_session_duration(FIGURES_FULL_PIPELINE_RESULTS_FOLDER, self.results_by_min_duration, self.flow_count_by_duration_correlated, self.sss.dataset_name)
