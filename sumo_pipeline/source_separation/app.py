...
def train(stats_file_train: str, model_save_file: str) -> None:
    ...
    Example:
        $ python3 app.py train /mnt/nas-shared/torpedo/extracted_features/extracted_features_OSTrain/stats_source_separation.csv source_separation_model.joblib
    """
...
def test_standalone(stats_file_test: str, 
    ...
    Example:
        $ python3 app.py test-standalone /mnt/nas-shared/torpedo/extracted_features/extracted_features_OSTest/stats_source_separation.csv source_separation_model_bayesian_optimization.joblib
    """
...
def plot(stats_file_test: str, 
    ...
    Example:
        $ python3 app.py plot /mnt/nas-shared/torpedo/extracted_features/extracted_features_OSTest/stats_source_separation.csv source_separation_model.joblib precision_recall_curve_source_separation_zoomin
    """
...
def top10_features(stats_file_test: str, model_save_file: str) -> None:
    ...
    Example:
        $ python3 app.py top10-features /mnt/nas-shared/torpedo/extracted_features/extracted_features_OSTest/stats_source_separation.csv source_separation_model.joblib
    """
